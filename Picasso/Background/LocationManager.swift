...
extension LocationManager
{
    ...
    enum Error: LocalizedError, RecoverableError
    {
        ...
        var failureReason: String? {
            switch self
            {
            case .requiresAlwaysAuthorization: return NSLocalizedString("OpenPicasso requires “Always” location permission.", comment: "")
            }
        }
        ...
        var recoverySuggestion: String? {
            switch self
            {
            case .requiresAlwaysAuthorization: return NSLocalizedString("Please grant OpenPicasso “Always” location permission in Settings so it can run in the background indefinitely.", comment: "")
            }
        }
