...
//#import "../Headers/NSUserDefaults.h"
...
//    {
//        if ([app.applicationIdentifier isEqualToString:@"net.sourceloc.Picasso"] || [app.applicationIdentifier isEqualToString:@"net.sourceloc.Picasso.Dev"])
//        {
//            isAppInstalled = YES;
//            break;
//        }
...
//}
//
//#define USER_DEFAULTS_PATH @"/var/mobile/Library/Preferences/ca.bomberfish.Picasso.plist"
//
